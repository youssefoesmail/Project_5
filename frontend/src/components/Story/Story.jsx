          ...
          <h1 class="pt-8 pb-3 font-semibold sm:text-lg text-gray-900">
            ...
            <ul id="gallery" className="flex flex-1 flex-wrap -m-1">
              <li id="empty" className="h-full w-full text-center flex flex-col items-center justify-center items-center">
                <img className="mx-auto w-32" src={storyImageUpload} alt="no data" />
                <span className="text-small text-gray-500">No files selected</span>
              </li>
            </ul>
        </Modal.Body>
        <Modal.Footer>
          <Button  onChange={(event) => {setOpenModal(false) ; setStoryImageUpload(event.target.files[0]);}}>I accept</Button>
